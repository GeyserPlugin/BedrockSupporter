...
public class ResidenceCreateSelectForm extends RSimpleForm {
    ...
    public ResidenceCreateSelectForm(Player player, RForm previousForm, Language language) {
    ...
    public void onValidResult(SimpleForm form, SimpleFormResponse response) {
        ...
        else if (id == 1) new ResidencePlayerSelectForm(bukkitPlayer,this, language).send();
        else if (id == 2) new ResidenceManualSelectForm(bukkitPlayer, this, language).send();
        else if (id == 3) new ResidenceSelectExpandAndContractForm(bukkitPlayer, this, language).send();
        else if (id == 4) new ResidenceCreateForm(bukkitPlayer,this, language).send();
    }
